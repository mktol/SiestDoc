...
public class DocumentController {
    ...
    @RequestMapping(value = DOCUMENTS_PATH, method = RequestMethod.GET)
    public
    @ResponseBody
    ...
    public
    @ResponseBody
    Document getDocumentById(@PathVariable(value = "docId", required = false) String docId) {
        return handleDocumentService.getDocumentById(docId);
    }

    @RequestMapping(value = DOCUMENTS_PATH + DOC_ID_PATH_VAR, method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = DOCUMENTS_PATH, method = RequestMethod.PUT)
    ...
    @RequestMapping(value = DOCUMENTS_PATH, method = RequestMethod.POST)
